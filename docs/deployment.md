...
URL: `https://agriturismo.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `agriturismo.demo.federicocalo.dev`
...
- Output directory: `dist/agriturismo/browser`
...
URL: `https://fedcal.github.io/federico-demo-agriturismo/`
...
- `base: /federico-demo-agriturismo/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `agriturismo-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   agriturismo-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `agriturismo-docs.federicocalo.dev`
