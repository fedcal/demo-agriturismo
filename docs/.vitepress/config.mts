...
const SLUG = 'agriturismo';
const TITLE = 'Demo Agriturismo — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Agriturismo.',
  base: `/demo-${SLUG}/`,
  cleanUrls: true,
