...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/demo-agriturismo
...
```bash
git clone https://github.com/fedcal/demo-agriturismo.git
cd demo-agriturismo
npm install
npm start
# → http://localhost:4200
...
- [GitHub repo](https://github.com/fedcal/demo-agriturismo)
